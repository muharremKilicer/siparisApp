...
public class KategorilerAlt extends AppCompatActivity {

    ListView liste;
    ArrayList<Kategoriler> arrayList = new ArrayList<>();
    String gelenCatId;
    //Tiklanan alt kategorinin idsini almak için
    static String tiklananAltCatId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kategoriler_alt);

        //Üstte bulunan action bar'a title verildi.
        this.setTitle("Alt Kategori");

        liste = (ListView) findViewById(R.id.altKatList);
        gelenCatId = KategorilerAct.tiklananCatId;
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                for (int i = 0; i < cat.length(); i++) {
                    ...
                    if (bil.getString("TopCatogryId").equals(gelenCatId)) {
                ...
                KategorilerAdp adp = new KategorilerAdp(KategorilerAlt.this, arrayList);
                ...
                liste.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        try {
                            ...
                            tiklananAltCatId = ur.getCatogryId();
                            //Bir sonraki sayfaya geçildi.
                            Intent i = new Intent(KategorilerAlt.this, UrunlerAct.class);
                            startActivity(i);
                        } catch (Exception e) {
